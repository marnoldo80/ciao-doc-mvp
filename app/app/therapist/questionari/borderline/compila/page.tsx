...
const config: QuestionnaireConfig = {
  ...
  emoji: '🌊',
  istruzioni: 'Rispondi sì (1) o no (0) per ciascuna delle seguenti affermazioni.',
  maxScore: 10,
  opzioniDefault: [
    { label: 'No (0)', valore: 0 },
    { label: 'Sì (1)', valore: 1 },
  ...
  domande: [
    { testo: 'Hai fatto delle cose impulsive che potrebbero causare danno a te (ad es. guida spericolata, sesso a rischio, spese eccessive)?' },
